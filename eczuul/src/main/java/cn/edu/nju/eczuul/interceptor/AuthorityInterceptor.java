//package cn.edu.nju.eczuul.interceptor;
//
//import cn.edu.nju.eczuul.annotations.AccessLimit;
//import cn.edu.nju.eczuul.redis.AccessKey;
...
////            user = (User) redisUtil.get(UserKey.getByName, loginToken);
////        }
////
////        if(needLogin) {
////            if(user == null) {
...
////        Integer count = (Integer) redisUtil.get(ak, key);
////        if(count  == null) {
////            redisUtil.set(ak, key, 1, seconds);
////        }else if(count < maxCount) {
////            redisUtil.incr(ak.getPrefix() + key, 1);
////        }else {
...
//        String str  = JSON.toJSONString(RestResponse.error(HttpStatus.INTERNAL_SERVER_ERROR,cm));
